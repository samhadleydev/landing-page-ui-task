...
var wpAjaxUrl='http://penguin.linux.test/arketask/wp-admin/admin-ajax.php';var flBuilderUrl='http://penguin.linux.test/arketask/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://penguin.linux.test/arketask/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://penguin.linux.test/arketask/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-61ae97d08b1f3 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){$(function(){var slider=$('.fl-node-61af08dd4a803 .fl-content-slider-wrapper').bxSlider({adaptiveHeight:true,auto:true,autoHover:true,autoControls:false,pause:3000,mode:'horizontal',speed:500,controls:false,infiniteLoop:true,pager:true,video:true,onSliderLoad:function(currentIndex){$('.fl-node-61af08dd4a803 .fl-content-slider-wrapper').addClass('fl-content-slider-loaded');$('.fl-node-61af08dd4a803 iframe').each(function(){var src=$(this).attr('src');$(this).attr('data-url',src);if(!$(this).is(':visible')||0===$(this).parents('.fl-slide-0:not(.bx-clone)').length){$(this).attr('src','');}});$('.fl-slide-0:not(.bx-clone) video[autoplay]').trigger('play');},onSlideBefore:function(ele,oldIndex,newIndex){this.stopAuto(true);$('.fl-node-61af08dd4a803 .fl-content-slider-navigation a').addClass('disabled');$('.fl-node-61af08dd4a803 .bx-controls .bx-pager-link').addClass('disabled');this.startAuto(true);},onSlideAfter:function(ele,oldIndex,newIndex){var prevSlide=$('.fl-node-61af08dd4a803 .fl-slide-'+oldIndex+':not(.bx-clone)'),newSlide=$('.fl-node-61af08dd4a803 .fl-slide-'+newIndex+':not(.bx-clone)');if(newSlide.find('iframe:visible').length){newSlide.find('iframe:visible').each(function(){var src=$(this).attr('data-url');$(this).attr('src',src);});}
if(prevSlide.find('iframe:visible').length){prevSlide.find('iframe:visible').each(function(){var src=$(this).attr('src');$(this).attr('src','');});}
$('.fl-node-61af08dd4a803 .fl-content-slider-navigation a').removeClass('disabled');$('.fl-node-61af08dd4a803 .bx-controls .bx-pager-link').removeClass('disabled');if(prevSlide.find('video').length){prevSlide.find('video').trigger('pause');}
$('.fl-node-61af08dd4a803 .fl-slide-'+newIndex+':not(.bx-clone)').find('video[autoplay]').trigger('play')}});slider.data('bxSlider',slider);});})(jQuery);(function($){window.onLoadFLReCaptcha=function(){var reCaptchaFields=$('.fl-grecaptcha'),widgetID;if(reCaptchaFields.length>0){reCaptchaFields.each(function(i){var self=$(this),attrWidget=self.attr('data-widgetid'),newID=$(this).attr('id')+'-'+i;if((typeof attrWidget!==typeof undefined&&attrWidget!==false)){return;}
...
$(this.nodeClass+' .fl-send-error').fadeIn();return false;}}};})(jQuery);(function($){$(function(){new FLBuilderContactForm({id:'61af0e5042aa9'});});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();
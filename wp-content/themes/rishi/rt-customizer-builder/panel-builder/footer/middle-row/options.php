			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'2_columns_layout' => [
						...
						'choices' => [
							'repeat(2, 1fr)' => [
								'src' => rt_customizer_image_picker_file('1-1'),
							],

							'2fr 1fr' => [
								'src' => rt_customizer_image_picker_file('2-1'),
							],

							'1fr 2fr' => [
								'src' => rt_customizer_image_picker_file('1-2'),
							],

							'3fr 1fr' => [
								'src' => rt_customizer_image_picker_file('3-1'),
							],

							'1fr 3fr' => [
								'src' => rt_customizer_image_picker_file('1-3'),
							],
						],

						'tabletChoices' => [
							'initial' => [
								'src' => rt_customizer_image_picker_file('stacked'),
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'3_columns_layout' => [
						...
						'choices' => [
							'repeat(3, 1fr)' => [
								'src' => rt_customizer_image_picker_file('1-1-1'),
							],

							'1fr 2fr 1fr' => [
								'src' => rt_customizer_image_picker_file('1-2-1'),
							],

							'2fr 1fr 1fr' => [
								'src' => rt_customizer_image_picker_file('2-1-1'),
							],

							'1fr 1fr 2fr' => [
								'src' => rt_customizer_image_picker_file('1-1-2'),
							],
						],
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'4_columns_layout' => [
						...
						'choices' => [
							'repeat(4, 1fr)' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-1'),
							],

							'1fr 2fr 2fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('1-2-2-1'),
							],

							'2fr 1fr 1fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('2-1-1-1'),
							],

							'1fr 1fr 1fr 2fr' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-2'),
							],
						],
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'5_columns_layout' => [
						...
						'choices' => [
							'repeat(5, 1fr)' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-1-1'),
							],

							'2fr 1fr 1fr 1fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('2-1-1-1-1'),
							],

							'1fr 1fr 1fr 1fr 2fr' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-1-2'),
							],

							'1fr 1fr 2fr 1fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('1-1-2-1-1'),
							],
						],
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'6_columns_layout' => [
						...
						'choices' => [
							'repeat(6, 1fr)' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-1-1-1'),
							],

							'2fr 1fr 1fr 1fr 1fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('2-1-1-1-1-1'),
							],

							'1fr 1fr 1fr 1fr 1fr 2fr' => [
								'src'   => rt_customizer_image_picker_file('1-1-1-1-1-2'),
							],

							'1fr 1fr 2fr 2fr 1fr 1fr' => [
								'src'   => rt_customizer_image_picker_file('1-1-2-2-1-1'),
							],
						],

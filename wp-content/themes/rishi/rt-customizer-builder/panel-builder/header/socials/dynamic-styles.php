...
// Icon size
$socialsIconSize = rt_get_akv('socialsIconSize', $atts, 15);
...
// Icon spacing
$socialsIconSpacing = rt_get_akv('socialsIconSpacing', $atts, 15);
...
rt_customizer_output_colors([
	'value' => rt_get_akv('headerSocialsIconColor', $atts),
	'default' => [
...
rt_customizer_output_colors([
	'value' => rt_get_akv('headerSocialsIconBackground', $atts),
	'default' => [
...
if (isset($has_transparent_header) && $has_transparent_header) {
	...
	// Icons custom color
	rt_customizer_output_colors([
		'value' => rt_get_akv('transparentHeaderSocialsIconColor', $atts),
		'default' => [
	...
	// Icons custom background
	rt_customizer_output_colors([
		'value' => rt_get_akv('transparentHeaderSocialsIconBackground', $atts),
		'default' => [
			'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
			'hover' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
		],
...
if (isset($has_sticky_header) && $has_sticky_header) {
	...
	// Icons custom color
	rt_customizer_output_colors([
		'value' => rt_get_akv('stickyHeaderSocialsIconColor', $atts),
		'default' => [
			'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
			'hover' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
		],
	...
	// Icons custom background
	rt_customizer_output_colors([
		'value' => rt_get_akv('stickyHeaderSocialsIconBackground', $atts),
		'default' => [
			'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
			'hover' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
		],

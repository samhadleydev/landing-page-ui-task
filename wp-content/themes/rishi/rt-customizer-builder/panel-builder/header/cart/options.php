		...
		'options' => [
			...
			'mini_cart_type' => [
				...
				'choices' => [
					...
					'type-1' => [
						'src'   => rt_customizer_image_picker_file('cart-1'),
						'title' => __('Type 1', 'rishi'),
					],

					'type-2' => [
						'src'   => rt_customizer_image_picker_file('cart-2'),
						'title' => __('Type 2', 'rishi'),
					],

					'type-3' => [
						'src'   => rt_customizer_image_picker_file('cart-3'),
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					'cart_drawer_type' => [
						...
						'choices' => [
							'dropdown' => [
								'src' => rt_customizer_image_picker_url('cart-1.svg'),
								'title' => __('Dropdown', 'rishi'),
							],

							'offcanvas' => [
								'src' => rt_customizer_image_picker_url('cart-2.svg'),

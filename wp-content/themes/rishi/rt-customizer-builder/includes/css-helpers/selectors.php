...
function rt_customizer_assemble_selector($selector)
{
...
function rt_customizer_mutate_selector($args = [])
{
	$args = wp_parse_args(
		$args,
		[
...
function rt_customizer_get_source_for($prefix)
{
	return [
		'strategy' => 'customizer',
		'prefix' => $prefix
...
if (!function_exists('rt_customizer_prefix_selector')) {
	function rt_customizer_prefix_selector($selector, $prefix = '')
	{
		if (empty($prefix)) {
			return $selector;
		}
...
if (!function_exists('rt_customizer_camel_case_prefix')) {
	function rt_customizer_camel_case_prefix($value, $prefix = '')
	{
		if (empty($prefix)) {
			return $value;
		}

...
if (!function_exists('rt_customizer_has_schema_org_markup')) {
	function rt_customizer_has_schema_org_markup()
	{
		return get_theme_mod('enable_schema_org_markup', 'yes') === 'yes';
	}
}

if (!function_exists('rt_customizer_schema_org_definitions')) {
	function rt_customizer_schema_org_definitions($place, $args = [])
	{
		$args = wp_parse_args(
			$args,
			[
		...
		if (!rt_customizer_has_schema_org_markup()) {
			...
			return rt_customizer_attr_to_html($value);
		}

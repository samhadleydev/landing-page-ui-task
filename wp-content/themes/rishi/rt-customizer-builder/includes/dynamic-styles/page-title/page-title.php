...
$hero_elements = rt_get_akv_or_customizer(
	'hero_elements',
	rt_customizer_get_page_title_source(),
	$default_hero_elements
);

if (
	rt_customizer_get_page_title_source()['strategy'] === 'customizer'
	&& (rt_customizer_get_page_title_source()['prefix'] === 'woo_categories'
		||
		rt_customizer_get_page_title_source()['prefix'] === 'author')
) {
	$default_type = 'type-2';
}
...
rt_customizer_output_font_css([
	'font_value' => rt_get_akv_or_customizer(
		'pageTitleFont',
		$page_title_source,
...
rt_customizer_output_colors([
	'value' => rt_get_akv_or_customizer('pageTitleFontColor', $page_title_source),
	'default' => [
...
rt_customizer_output_colors([
	'value' => rt_get_akv_or_customizer('pageMetaFontColor', $page_title_source),
	'default' => [
		'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
...
rt_customizer_output_colors([
	'value' => rt_get_akv_or_customizer('pageExcerptColor', $page_title_source),
	'default' => [
		'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
	],
	'css' => $css,
...
rt_customizer_output_colors([
	'value' => rt_get_akv_or_customizer('breadcrumbsFontColor', $page_title_source),
	'default' => [
		'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
		'initial' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
		'hover' => ['color' => RT_CSS_Injector::get_skip_rule_keyword('DEFAULT')],
	],
	'css' => $css,
	'variables' => [
...
if ($type === 'type-1') {
	$hero_alignment1 = rt_get_akv_or_customizer(
		'hero_alignment1',
		$page_title_source,
		apply_filters(
			'rishi:hero:type-1:default-alignment',
			'left',
			rt_customizer_manager()->screen->get_prefix()
		)
	);
	...
	rt_customizer_output_responsive([
		...
		'value' => rt_get_akv_or_customizer('hero_margin', $page_title_source, [
			'desktop' => 50,
			'tablet' => 30,
			'mobile' => 30,
...
if ($type === 'type-2') {
	...
	$hero_alignment2 = rt_get_akv_or_customizer('hero_alignment2', $page_title_source, 'center');
	...
	$hero_vertical_alignment = rt_get_akv_or_customizer('hero_vertical_alignment', $page_title_source, 'center');
	...
	// height
	$hero_height = rt_get_akv_or_customizer('hero_height', $page_title_source, '250px');
	...
	rt_customizer_output_colors([
		...
		'default' => [
			'default' => ['color' => RT_CSS_Injector::get_skip_rule_keyword()]
		],
		'css' => $css,
		'variables' => [
			'default' => [
...
foreach ($hero_elements as $index => $single_hero_element) {
	...
	$hero_item_spacing = rt_get_akv('hero_item_spacing', $single_hero_element, 20);
...
$alignment = rt_customizer_akg_or_customizer(
...
rt_customizer_output_responsive([
    ...
    'variableName' => 'margin-bottom',
    'value' => rt_get_akv_or_customizer('single_page_margin', $source, [
        'desktop' => 50,
        'tablet' => 30,
        'mobile' => 30,
...
rt_customizer_output_box_shadow([
	...
	'value' => rt_get_akv_or_customizer( 'single_page_content_boxed_shadow', $source, rt_customizer_box_shadow_value([
		'enable'   => false,
		'h_offset' => 0,
		'v_offset' => 12,
		'blur'     => 18,

 ...
 * @return void
 */
function rt_customizer_customizer_register_options(
    $wp_customize,
    $options,
    $settings = []
) {
    ...
    foreach ($collected as &$opt) {
        ...
        if ('container' === $opt['group']) {
            ...
            $args = [
                'title' => empty($opt['option']['title'])
                    ? rt_customizer_id_to_title($opt['id'])
                    : $opt['option']['title'],
            ...
            rt_customizer_customizer_register_options(
                $wp_customize,
                $opt['option']['options'],
                [
        ...
        if ('option' === $opt['group']) {
            ...
            $opt['option'] = rt_customizer_include_sanitizer($opt['option']);
            ...
            if (isset($opt['option']['sync'])) {
                ...
                if (is_array($opt['option']['sync'])) {
                    ...
                    foreach ($all_syncs as $index => $single_sync) {
                        ...
                        if (!empty(rt_customizer_prefix_selector('', $local_sync['prefix']))) {
                            $prefix_selector = rt_customizer_prefix_selector(
                                '',
                                $local_sync['prefix']
                            );

...
$breaddefaults = rishi_get_breadcrumbs_defaults();
$meta_options = rt_customizer_get_options('general/meta', [
	'prefix'        => 'related_post',
	'has_label'     => true,
	'meta_elements' => rishi_get_default_postmeta_structure(),
	'skip_sync_id'  => 'related_post_divider'
]);
$prefix   = 'single_post_';
$options  = [
	'layouts_singlepost_options' => [
		'type'               => 'rt-options',
		'setting'            => ['transport' => 'postMessage'],
		'customizer_section' => 'container',
		'inner-options'      => [	
			'breadcrumbs_ed_single_post' => [
				'label'   => __('Breadcrumb', 'rishi'),
				'desc'    => __('This setting enables Breadcrumb in a single post.', 'rishi'),
				'type'    => 'rara-switch',
					...
					rt_customizer_rand_md5() => [
						...
						'type'    => 'tab',
							'options'   => [
								...
								rt_customizer_rand_md5() => [
									'type'      => 'rt-condition',
									'condition' => [ 'underlinestyle' => 'style2' ],
									'options'   => [
										'linkHighlightBackgroundColor' => [
			...
			rt_customizer_rand_md5() => [
				...
				'options' => [
					...
					rt_customizer_rand_md5() => [
						'type'      => 'rt-condition',
						'condition' => [ 'blog_post_layout' => '!full_width_contained' ],
						'options'   => [
			...
			rt_customizer_get_options('general/post-structure', [
				'prefix'    => 'single_blog_post',
				'is_single' => true,
			]),		
			'ed_post_tags' => [
				'label'   => __('Display post tags', 'rishi'),
				'type'    => 'rara-switch',
			...
			rt_customizer_rand_md5() => [
				'type'      => 'rt-condition',
				'condition' => ['ed_related' => 'yes'],
				'options'   => [
					'single_related_title' => [
						'label'  => __('Related Posts Section Title', 'rishi'),
						'type'   => 'text',
						'design' => 'block',
						'sync'   => [
							'selector' => '.blog-single-wid-title',
							'render'   => function() { echo rishi_get_related_post_info(); }
						],
						'value' => $defaults['single_related_title'],
					],
					'related_taxonomy' => [
						'label'   => __('Related Post Taxonomy', 'rishi'),
						'desc'    => __('Choose Categories or Tags to display related posts based on.', 'rishi'),
						'type'    => 'rt-select',
					...
					'no_of_related_post' => [
						'label'  => __('Number of Related Posts', 'rishi'),
						'type'   => 'rt-number',
						'design' => 'inline',
					...
					'related_post_per_row' => [
						'label'  => __('Related Posts Per Row', 'rishi'),
						'type'   => 'rt-number',
						'design' => 'inline',
					...
					rt_customizer_rand_md5() => [
						'label'         => __('Related Posts Meta Structure', 'rishi'),
						'type'          => 'rt-panel',
						'value'         => 'yes',
					...
					'ed_related_after_comment' => [
						'label' => __('Show Related Posts After Comments', 'rishi'),
						'type'  => 'rara-switch',
						'value' => $defaults['ed_related_after_comment'],
						'desc'  => __('Enable to show related posts after comment section or keep it disabled to show related posts before the comment section.', 'rishi'),
					],
				]
			],
			'ed_comment' => [
				...
				'divider' => 'top',
				'desc'    => __(' Enable to show comment section.', 'rishi'),
			],
			rt_customizer_rand_md5() => [
				'type'      => 'rt-condition',
				'condition' => ['ed_comment' => 'yes'],
				'options'   => [
					'ed_comment_form_above_clist' => [
						'label' => __('Show Comment form above Comments list', 'rishi'),
						'type'  => 'rara-switch',
						'value' => $defaults['ed_comment_form_above_clist'],
						'desc'  => __('Enable to show Comment form above the Comments list.', 'rishi'),
					],
					'ed_comment_below_content' => [
						'label' => __('Show Comment section below the content', 'rishi'),
						'type'  => 'rara-switch',
						'value' => $defaults['ed_comment_below_content'],
						'desc'  => __('Enable to show comment section below the content.', 'rishi'),
					],
				]
			],
			'ed_show_post_navigation' => [
				'label'   => __('Show Post Navigations', 'rishi'),
				'type'    => 'rara-switch',
				'value'   => $defaults['ed_show_post_navigation'],
				'divider' => 'top',
			],
			'ed_show_post_author' => [
				'label'   => __('Show Post Author', 'rishi'),
				'type'    => 'rara-switch',
			...
			'single_content_area_spacing' => [
				...
				'desc'  => sprintf(
					__('You can set the spacing value under General > Layouts > Container. Click %shere%s to configure it.', 'rishi'),
					sprintf(

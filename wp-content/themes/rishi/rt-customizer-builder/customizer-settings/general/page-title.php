...
$when_enabled_general_settings = [
	$has_hero_type ? [
		$prefix . 'hero_section' => [
			...
			'choices' => [
				'type-1' => [
					'src' => rt_customizer_image_picker_url('hero-type-1.svg'),
					'title' => __('Type 1', 'rishi'),
				],

				'type-2' => [
					'src' => rt_customizer_image_picker_url('hero-type-2.svg'),
			...
			'sync' => [
				[
					...
					'render' => function ($args) {
						echo rt_customizer_output_hero_section([
							'type' => get_theme_mod(
...
$options_when_default = [
	$prefix . 'has_hero_section' => [
		// 'label' => $is_page ? __('Page Title', 'rishi') : __(
		// 	'Post Title', 'rishi'
		// ),
		'label' => false,
		'type' => 'rt-radio',

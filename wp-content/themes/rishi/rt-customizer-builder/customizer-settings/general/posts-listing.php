...
$options = [
	...
	$prefix . 'structure' => [
		...
		'choices' => [
			'simple' => [
				'src' => rt_customizer_image_picker_url('simple.svg'),
				'title' => __('Simple', 'rishi'),
			],

			'classic' => [
				'src' => rt_customizer_image_picker_url('classic.svg'),
				'title' => __('Classic', 'rishi'),
			],

			'grid' => [
				'src' => rt_customizer_image_picker_url('grid.svg'),
				'title' => __('Grid', 'rishi'),
			],

			'enhanced-grid' => [
				'src' => rt_customizer_image_picker_url('enhanced-grid.svg'),
				'title' => __('Enhanced Grid', 'rishi'),
			],

			'gutenberg' => [
				'src' => rt_customizer_image_picker_url('gutenberg.svg'),
					...
					$prefix . 'archive_order' => apply_filters('rishi:options:posts-listing-archive-order', [
						...
						'settings' => [
							...
							'featured_image' => [
								...
								'options' => [
									...
									'image_size' => [
										...
										'choices' => rt_customizer_ordered_keys(
											rt_customizer_get_all_image_sizes()
										),
									],
							...
							'post_meta' => [
								...
								'options' => rt_customizer_get_options('general/meta', [
									'is_cpt' => $is_cpt,
									'skip_sync_id' => [
										'id' => $prefix . 'archive_order_skip'
									],

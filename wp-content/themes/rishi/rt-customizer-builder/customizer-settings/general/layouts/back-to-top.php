				...
				'options' => [
					...
					'top_button_type' => [
						...
						'choices' => [
							...
							'type-1' => [
								'src'   => rt_customizer_image_picker_file('top-1'),
								'title' => __('Type 1', 'rishi'),
							],

							'type-2' => [
								'src'   => rt_customizer_image_picker_file('top-2'),
								'title' => __('Type 2', 'rishi'),
							],

							'type-3' => [
								'src'   => rt_customizer_image_picker_file('top-3'),
								'title' => __('Type 3', 'rishi'),
							],
							'type-4' => [
								'src'   => rt_customizer_image_picker_file('top-4'),

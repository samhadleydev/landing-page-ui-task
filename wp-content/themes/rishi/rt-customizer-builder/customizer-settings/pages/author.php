	...
	'layouts_author_options' => [
		...
		'inner-options'      => [
				...
				'inner-options' => [
					rt_customizer_rand_md5() => [
						...
						'options' => [
							'author_page_label' => [
								...
								'type'   => 'text',
								'sync' => [
									'selector' => '.author-name .vcard',
									'render' => function() { echo rishi_get_author_meta_info(); }
								],
								'design' => 'block',
								'value'  => __( 'By','rishi' ),
							],
							'author_page_avatar_ed' => [
							...
							rt_customizer_rand_md5() => [
								'type'      => 'rt-condition',
								'condition' => ['author_page_avatar_ed' => 'yes'],
								'options'   => [
									...
									'author_page_avatar_types' => [
										'label'   => __('Avatar Types', 'rishi'),
										'type'    => 'rt-radio',
										'value'   => 'circle',
										'view'    => 'text',
										'attr'    => ['data-type' => 'author'],
                            			'sync'    => "live",
										'choices' => [
							...
							rt_customizer_rand_md5() => [
								'type' => 'rt-condition',
								'condition' => [ 'author_page_search_ed' => 'yes' ],
								'options' => [
					...
					rt_customizer_rand_md5() => [
						...
						'options' => [
							...
							'author_page_color' => [
								'label'           => __('Author Font Color', 'rishi'),
			...
			'author_page_layout' => [
				...
				'desc'    => __('Choose sidebar layout for Author page.', 'rishi'),
				'type'    => 'rt-image-picker',
				'value'   => $defaults['author_page_layout'],
				'choices' => [
					'classic' => [
			...
			'author_post_navigation' => [
				'label'   => __('Posts Navigation', 'rishi'),
				'type'    => 'rt-select',
				'value'   => $defaults['author_post_navigation'],
				'view'    => 'text',
				'design'  => 'inline',
				'divider' => 'top',
				'choices' => rt_customizer_ordered_keys([
			...
			rt_customizer_rand_md5() => [
				'type'      => 'rt-condition',
				'condition' => [ 'author_page_layout' => 'grid | masonry_grid' ],
				'options'   => [                    
                    'author_posts_per_row' => [
                        'label'      => __('Number of Posts per Row', 'rishi'),
                        'type'       => 'rt-number',
                        'design'     => 'inline',
                        'value'      => $defaults['author_posts_per_row'],
                        'min'        => 2,
                        'max'        => 4,
                        'divider'    => 'top',
                        'responsive' => false,
			...
			'author_sidebar_layout' => [
				'label'   => __('Sidebar Layout', 'rishi'),
				'type'    => 'rt-image-picker',
				'value'   => $defaults['author_sidebar_layout'],
				'attr'  => [
			...
			'author_layout' => [
                ...
                'desc' => __('Choose Author page container layout.', 'rishi'),
            ],
            'author_layout_streched_ed' => [
                'label'   => __('Stretch Layout', 'rishi'),
                'desc'    => __('This setting stretches the container width.', 'rishi'),
                'type'    => 'rara-switch',
                'value'   => $defaults['author_layout_streched_ed'],
            ],
		],
	],
];

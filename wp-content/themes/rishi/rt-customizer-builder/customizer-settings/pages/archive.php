	...
	'layouts_archive_options' => [
		...
		'inner-options'      => [
			'archive_title_panel' => [
				...
				'inner-options' => [
					rt_customizer_rand_md5() => [
						...
						'type'    => 'tab',
						'options' => [
							'archive_page_prefix_ed' => [
								'label'   => __('Prefix', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'no',
							],
							'breadcrumbs_ed_archive' => [
								'label'   => __('Breadcrumb', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => $breaddefaults['breadcrumbs_ed_archive'],
							],
							'archive_page_title_ed' => [
								'label'   => __('Archive Title', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'yes',
							],
							'archive_page_desc_ed' => [
								'label'   => __('Archive Description', 'rishi'),
								'desc'    => __('You have to add Archive Description. It works for Tags and Categories of the Post', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'no',
								'divider' => 'top',
							],
							'archive_page_alignment' => [
								...
								'desc'       => __('Horizontal Alignment works for title only', 'rishi'),
								'value'      => 'left',
								'view'       => 'text',
							...
							'archive_page_search_ed' => [
								'label'   => __('Show Counts', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'yes',
							],
							rt_customizer_rand_md5() => [
								'type' => 'rt-condition',
								'condition' => [ 'archive_page_search_ed' => 'yes' ],
								'options' => [
									'archive_page_archive_margin' => [
										'label' => __('Bottom Margin', 'rishi'),
										'type' => 'rt-slider',
										'value' => 30,
										'min' => 0,
										'max' => 300,
					...
					rt_customizer_rand_md5() => [
						...
						'options' => [
							...
							'archive_font_title_color' => [
								'label'           => __('Archive Font Color', 'rishi'),
			...
			'archive_page_layout' => [
				...
				'desc'    => __('Choose sidebar layout for Archive page.', 'rishi'),
				'type'    => 'rt-image-picker',
				'value'   => $defaults['archive_page_layout'],
				'attr'  => [
					'data-usage'   => 'blog-layout-style',
				],
				'choices' => [
					'classic' => [
			...
			'archive_post_structure' => [
				'label'    => __('Post Elements', 'rishi'),
				'type'     => 'rt-layers',
				'attr'     => ['data-layers' => 'title-elements'],
				'design'   => 'block',
				'divider'  => 'top',
				'value'    => rishi_get_default_blogpost_structure(),
				'settings' => [
					'excerpt' => [
					...
					'divider' => [
						...
						'sync'  => [
							'id' => 'archive_order_meta'
						],
					],		
					'featured_image' => [
						'label'   => __('Featured Image', 'rishi'),
						'options' => rt_customizer_get_options( 'single-elements/featured-image' ),
					],		
					'custom_title' => [
					...
					'custom_meta' => [
						...
						'options' => [
							rt_customizer_get_options('general/meta', [
								'skip_sync_id' => [
			...
			'archive_post_navigation' => [
				'label'   => __('Posts Navigation', 'rishi'),
				'type'    => 'rt-select',
				'value'   => $defaults['archive_post_navigation'],
				'view'    => 'text',
				'design'  => 'inline',
				'divider' => 'top',
				'choices' => rt_customizer_ordered_keys([
			...
			rt_customizer_rand_md5() => [
				'type'      => 'rt-condition',
				'condition' => [ 'archive_page_layout' => 'grid | masonry_grid' ],
				'options'   => [                    
                    'archive_posts_per_row' => [
                        'label'      => __('Number of Posts per Row', 'rishi'),
                        'type'       => 'rt-number',
                        'design'     => 'inline',
                        'value'      => $defaults['archive_posts_per_row'],
                        'min'        => 2,
                        'max'        => 4,
                        'divider'    => 'top',
                        'responsive' => false,
			...
			'archive_sidebar_layout' => [
				'label'   => __('Sidebar Layout', 'rishi'),
				'type'    => 'rt-image-picker',
				'value'   => $defaults['archive_sidebar_layout'],
				'attr'  => [
			...
			'archive_layout' => [
                'label'   => __('Archive Container', 'rishi'),
                'type'    => 'rt-select',
                'value'   => $defaults['archive_layout'],
                'view'    => 'text',
                'design'  => 'inline',
                'divider' => 'top',
                'choices' => rt_customizer_ordered_keys([
                ...
                'desc' => __('Choose Archive page container layout.', 'rishi'),
            ],
            'archive_layout_streched_ed' => [
                'label'   => __('Stretch Layout', 'rishi'),
                'desc'    => __('This setting stretches the container width.', 'rishi'),
                'type'    => 'rara-switch',
                'value'   => $defaults['archive_layout_streched_ed'],
            ],
		],
	],
];

		...
		'customizer_section' => 'container',
            'inner-options'      => [
                'page_title_panel' => [
                    ...
                    'inner-options' => [
                        'breadcrumbs_ed_single_page' => [
                            ...
                            'desc'    => __('This setting enables Breadcrumb in a single page.', 'rishi'),
                            'type'    => 'rara-switch',
                ...
                rt_customizer_rand_md5() => [
                    ...
                    'options' => [
                        ...
                        'page_content_area_spacing' => [
                            ...
                            'desc' => sprintf(
                                __('You can customize the spacing value in general settings panel. Configure Page Vertical Spacing from %shere%s.', 'rishi'),
                                sprintf(
                                    '<a href="%s" data-trigger-section="layout">',
                                    admin_url('/customize.php?autofocus[section]=layout')
                                ),
                                '</a>'
                            ),
                            'type'    => 'rt-radio',
                ...
                $prefix . 'has_featured_image' => [
                    ...
                    'value'         => 'yes',
                    'inner-options' => [
                        rt_customizer_get_options( 'single-elements/featured-image', [ 'prefix' => 'single_page' ] )
                    ]    
                ],
                $prefix . 'ed_comment' => [

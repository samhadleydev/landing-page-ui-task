...
class RT_CSS_Injector
{
	...
	public function build_css_structure()
	{
		...
		if (isset($this->attr[RT_CSS_Injector::get_inline_keyword()])) {
			$content = implode('', $this->attr[RT_CSS_Injector::get_inline_keyword()]);
			unset($this->attr[RT_CSS_Injector::get_inline_keyword()]);
		}
	...
	private function normalize_inputs($selector, $preliminary_rules)
	{
		...
		if ($selector === RT_CSS_Injector::get_inline_keyword()) {

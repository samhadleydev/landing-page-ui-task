...
$archive_structure   = get_theme_mod( 'archive_post_structure', rishi_get_default_blogpost_structure() );
$archive_page_layout = get_theme_mod( 'archive_page_layout', $defaults['archive_page_layout'] );

if( is_author() ){
	$archive_structure   = get_theme_mod( 'author_post_structure', rishi_get_default_blogpost_structure() );

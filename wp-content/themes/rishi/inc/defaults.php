...
if( ! function_exists( 'rishi_get_typography_defaults' ) ): 
/**
 * Typography Defaults
 */
function rishi_get_typography_defaults(){
    $defaults = array(
        'body' => array(
            'family'           => 'System Stack',
            'variants'         => '',
...
if( ! function_exists( 'rishi_get_color_defaults' ) ): 
/**
 * Color Defaults
 */
function rishi_get_color_defaults(){
    $defaults = array(
        'primary_color'                         => 'var(--paletteColor1)',
        'base_color'                            => 'var(--paletteColor7)',
        'genLinkColor'                          => 'var(--paletteColor3)',
        'genLinkHoverColor'                     => 'var(--paletteColor2)',
        ...
        'woo_btn_text_hover_color'              => 'var(--paletteColor3)',
        'woo_btn_bg_color'                      => 'var(--paletteColor3)',
        'woo_btn_bg_hover_color'                => 'var(--paletteColor5)',
        'woo_btn_border_color'                  => 'var(--paletteColor3)',
        'woo_btn_border_hover_color'            => 'var(--paletteColor3)',
    );

    return apply_filters( 'rishi_color_options_defaults', $defaults );
}
endif;

if( ! function_exists( 'rishi_get_background_defaults' ) ): 
/**
 * Background Defaults
 */
function rishi_get_background_defaults(){
    ...
    return apply_filters( 'rishi_background_options_defaults', $defaults );
}
endif;

if( ! function_exists( 'rishi_get_breadcrumbs_defaults' ) ): 
/**
 * Button Defaults
 */
function rishi_get_breadcrumbs_defaults(){
...
if( ! function_exists( 'rishi_get_button_defaults' ) ): 
/**
 * Button Defaults
 */
function rishi_get_button_defaults(){
...
if( ! function_exists( 'rishi_get_layouts_defaults' ) ): 
/**
 * Layouts Overall All Defaults
 */
function rishi_get_layouts_defaults(){
...
if( ! function_exists( 'rishi_get_default_post_structure' ) ): 
    function rishi_get_default_post_structure(){
...
if( ! function_exists( 'rishi_get_default_blogpost_structure' ) ): 
    function rishi_get_default_blogpost_structure(){
        ...
        $default_post_structure[] = [
            'id'      => 'divider',
            'enabled' => true,
            'divider_margin' => rt_customizer_spacing_value([
                'top'    => '0',
                'bottom' => '20px',
                'left'   => 'auto',
                'right'  => 'auto',
...
if( ! function_exists( 'rishi_get_default_postmeta_structure' ) ) :
    function rishi_get_default_postmeta_structure(){
        return rt_customizer_post_meta_defaults([
            [
                'id'      => 'post_date',
                'enabled' => true,
            ],

...
// register Construction_Landing_Page_Popular_Post widget
function construction_landing_page_register_popular_post_widget() {
    register_widget( 'Construction_Landing_Page_Popular_Post' );
}
add_action( 'widgets_init', 'construction_landing_page_register_popular_post_widget' );

/*
 * Adds Construction_Landing_Page_Popular_Post widget.
*/
class Construction_Landing_Page_Popular_Post extends WP_Widget {
	/**
	 * Register widget with WordPress.
    */
	function __construct() {
		parent::__construct(
			'construction_landing_page_popular_post', // Base ID
			__( 'RARA: Popular Post', 'construction-landing-page' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'construction-landing-page' ), ) // Args
		);
	}
                        ...
                        <?php 
                            if( $show_thumb ){
                                ...
                                if( has_post_thumbnail() ){                                    
                                    the_post_thumbnail( 'construction-landing-page-recent', array( 'itemprop' => 'image' ) );                                    
                                }else{
                                    construction_landing_page_get_fallback_svg( 'construction-landing-page-recent' );
                                } 
                                echo '</a>';
                            }
                        ?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'construction-landing-page' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'construction-landing-page' ); ?></label>
		</p>
		<?php 
	}
...
} // class Construction_Landing_Page_Popular_Post 
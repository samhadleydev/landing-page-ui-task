 ...
 */
// register Construction_Landing_Page_Recent_Post widget

function construction_landing_page_register_recent_post_widget() {

    register_widget( 'Construction_Landing_Page_Recent_Post' );

}

add_action( 'widgets_init', 'construction_landing_page_register_recent_post_widget' );
/**
 * Adds Construction_Landing_Page_Recent_Post widget.
 */
class Construction_Landing_Page_Recent_Post extends WP_Widget {
	/**
	...
	function __construct() {
		parent::__construct(
			...
			'construction_landing_page_recent_post', // Base ID

			__( 'RARA: Recent Post', 'construction-landing-page' ), // Name

			array( 'description' => __( 'A Recent Post Widget', 'construction-landing-page' ), ) // Args
...
} // class Construction_Landing_Page_Recent_Post 